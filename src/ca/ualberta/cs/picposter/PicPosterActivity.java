...
public class PicPosterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.searchPostsEditText = (EditText) this
				.findViewById(R.id.search_posts_edit_text);
		this.addPicImageView = (ImageView) this
				.findViewById(R.id.add_pic_image_view);
		this.addPicEditText = (EditText) this
				.findViewById(R.id.add_pic_edit_text);
		...
		this.adapter = new PicPostModelAdapter(this, R.layout.pic_post,
				model.getList());
	...
	public void pushPicture(View view) {
		this.controller.addPicPost(this.currentPicture, this.addPicEditText
				.getText().toString());
	...
	public void searchPosts(View view) {
		...
		ArrayList<PicPostModel> searchResult = new ArrayList<PicPostModel>();

		try {
			searchResult = ElasticSearchOperations
					.searchsearchPicPost(searchTerm);
		...
		this.model.setList(searchResult);
